...
public class View6 extends JPanel {
    ...
    // update 28/set/2022 allows separated polygons
    public class Visplane {
        
        public static final int MAX_FRAGMENTED_SPANS = 32;
...
//
//        polygon.reset();
//        polygon.addPoint(50, 30);
//        polygon.addPoint(50, 70);
//        polygon.addPoint(75, 30);
...
//        g.fill(polygon);
        ...
        polygon.addPoint(15, 28);
        polygon.addPoint(40, 20);
        polygon.addPoint(52, 12);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            frame.setTitle("DOOM Visplane Vertical Columns to Horizontal Spans Conversion Test #6");
